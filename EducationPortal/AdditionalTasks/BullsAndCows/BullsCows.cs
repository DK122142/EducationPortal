...
namespace EducationPortal.AdditionalTasks.BullsAndCows
{
    public class BullsCows
    {
        ...
        {
            List = Service.GenerateCombinations();
        ...
        public static bool ToGuess()
        {
            ...
            {
                Console.WriteLine("Digit between 0 and 4");
                Count--;
                Start();
            }
            else if (bull == 4 && cow == 0){
                Console.WriteLine("Your secret number is " + guessStr);
                return true;
            }
            ...
            if (List.Count == 1)
            {
                ...
                {
                    Console.WriteLine("Secret number is " + guessStr);
                    return true;
                }
                return true;
            }
        ...
        {
            // int[] result = new int[string.Join("", number).Length];
